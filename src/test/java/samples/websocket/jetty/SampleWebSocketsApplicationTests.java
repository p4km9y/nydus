...
import sk.javot.nydus.NydusApplication;
import sk.javot.nydus.client.GreetingService;
import sk.javot.nydus.client.SimpleClientWebSocketHandler;
import sk.javot.nydus.client.SimpleGreetingService;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = NydusApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext
